...
# Preserve OSK composition when layout moves the rendered caret.
# Regression: 1d83c7a953209c27a38e92a13fb420493f96669b
Patch100:       gtk4-wayland-preserve-preedit-on-layout.patch

# Image composition requires this capability until Fedora carries the fix.
Provides:       gtk4-wayland-preedit-fix = 1
...
%changelog
* Sun Sep 06 2026 Sam Day <me@samcday.com> - 4.23.4-1.1.pocketfed
- Preserve Wayland OSK preedit during caret geometry updates
- Rebuild Fedora packaging from 5f64a17f802215eb67573290fb9066aa662a460e
