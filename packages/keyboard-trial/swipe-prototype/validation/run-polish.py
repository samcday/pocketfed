...
parser.add_argument("--case", choices=["swipe", "swipe-tap", "swipe-next", "swipe-undo", "swipe-edit", "swipe-focus", "swipe-shift", "typed-undo", "typed-reselect", "undo-focus", "literal"], default="literal")
