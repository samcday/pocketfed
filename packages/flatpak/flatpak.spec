...
Source2:        test-start-notification.py
Source3:        test-start-notification.c.in

# https://github.com/flatpak/flatpak/pull/6785
Patch:          fd-conflation.patch
# https://github.com/flatpak/flatpak/pull/6787
Patch:          eagain.patch
# Retry instance construction until asynchronously published PID metadata exists.
# https://github.com/samcday/pocketfed/issues/35
Patch:          flatpak-1.19.0-retry-instance-pid.patch
...
%check
CC="%{__cc}" %{__python3} %{SOURCE2} %{SOURCE0} --prepared-source .
...
%changelog
* Wed Sep 09 2026 Sam Day <me@samcday.com> - 1.19.0-3.1.pocketfed
- Retry Flatpak portal instance construction while PID metadata is unpublished
- Check prepared production callbacks against the delayed-PID regression

* Thu Sep 03 2026 Lukas Slebodnik <lslebodn@fedoraproject.org> - 1.19.0-3
...
* Mon Aug 24 2026 Michael Catanzaro <mcatanzaro@gnome.org> - 1.19.0-2
- Add patches to fix Epiphany crashes

* Wed Aug 12 2026 nmontero <nmontero@redhat.com> - 1.19.0-1
- Update to 1.19.0

* Wed Aug 12 2026 David King <amigadave@amigadave.com> - 1.18.1-1
- Update to 1.18.1

* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.18.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Mon Jun 08 2026 David King <amigadave@amigadave.com> - 1.18.0-1
- Update to 1.18.0 (#2466936)

* Tue May 12 2026 Michael Catanzaro <mcatanzaro@gnome.org> - 1.17.7-3
- Revert "Temporarily disable malcontent dependency"

* Tue May 12 2026 Michael Catanzaro <mcatanzaro@gnome.org> - 1.17.7-2
- Temporarily disable malcontent dependency
...
* Wed Mar 25 2026 Jan Grulich <jgrulich@redhat.com> - 1.17.3-3
