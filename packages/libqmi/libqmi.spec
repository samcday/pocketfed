...
# Upstream 082bf3454c011e1481375e843a0c91c9e338d422, no C ABI changes.
Patch0: 0001-fix-GArray-introspection.patch
# Existing PocketFed fix 80384c0db2b5eaf376a23521d44ccec9c24299ca.
Patch1: 0002-qmicli-pdc-do-not-free-mapped-file-contents.patch
Source1: test-introspection.py
...
%install
%meson_install
find %{buildroot}%{_docdir}/libqmi-glib-1.0 -exec touch --reference=meson.build {} +
...
%check
%meson_test
%{python3} %{SOURCE1} %{_vpath_builddir}/src/libqmi-glib/Qmi-1.0.gir
...
%changelog
* Sat Sep 12 2026 PocketFed maintainers <me@samcday.com> - 1.38.0-1.1.pocketfed
- Update to stable libqmi 1.38.0 for ModemManager 1.25.95
- Build and package the gi-docgen API reference in its new documentation path
- Retain nested GArray annotations and generated-GIR regression checks
- Carry the existing qmicli PDC mapped-file ownership fix

* Thu Sep 10 2026 PocketFed maintainers <me@samcday.com> - 1.36.0-4.1.pocketfed
- Backport upstream nested GArray element annotations for PyGObject 3.56+

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.36.0-4
