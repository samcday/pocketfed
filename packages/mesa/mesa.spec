...
Version:        26.2.2
Release:        6.2.pocketfed.a3xxfs%{?dist}
...
# PocketFed #80 Patch A: retain UBO loads in pre-a4xx fragment shaders.
Patch0:         A-fd3-no-fs-push-ubo.patch
...
%changelog
* Tue Sep 22 2026 Sam Day <me@samcday.com> - 26.2.2-6.2.pocketfed.a3xxfs
- Avoid indirect fragment constant uploads on Adreno a3xx (PocketFed #80 Patch A)
